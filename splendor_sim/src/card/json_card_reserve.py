...
class JsonCardReserve(card_reserve.CardReserve, i_json_buildable_object.IJsonBuildableObject):
    ...
    def build_from_json(
        ...
        card_manager = json_card_manager.JsonCardManager.build_from_json(json["card_manager"], incomplete_game_state)
        ...
        for deck_json in json["decks"]:
            decks.add(json_deck.JsonDeck.build_from_json(deck_json, incomplete_game_state))
