...
class JsonCoinReserve(coin_reserve.CoinReserve, i_json_buildable_object.IJsonBuildableObject):

    _JSON_VALIDATOR = json_validator.JsonValidator(json_schemas.JSON_COIN_RESERVE_SCHEMA)
    ...
    def build_from_json(
        ...
        coin_type_manager = \
            json_coin_type_manager.JsonCoinTypeManager.build_from_json(json["coin_type_manager"])
