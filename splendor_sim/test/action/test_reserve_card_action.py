...
class TestReserveCardAction(unittest.TestCase):
    def setUp(self):
        ...
        self._mock_coin_type = mock.create_autospec(
    ...
    def test_reserve_card_action_init_invalid_coin_type(self):
        # Arrange
        self._mock_valid_coin_type_set = set(
    ...
    def test_collect_three_coins_action_execute_invalid_game_state_can_not_reserve_more_cards(
        self
    ):
        # Arrange
        self._mock_card_inventory.get_number_of_reserved_cards.return_value = 3
    ...
    def test_collect_three_coins_action_execute_player_gains_card(self):
        ...
        test_action.execute(self._mock_game_state)
        # Assert
        self._mock_card_inventory.add_card_to_reserved.assert_called_once_with(
            self._mock_card
        )
