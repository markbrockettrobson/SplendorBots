...
class TestJsonCoinTypeManager(unittest.TestCase):
    def setUp(self):
        ...
        self._mock_json = {
            ...
            'coin_equivalents': [
                {
                    "coin_name": "name_5",
                    "equivalent_coins_name": "name_0"
                },
                {
                    "coin_name": "name_5",
                    "equivalent_coins_name": "name_1"
                },
                {
                    "coin_name": "name_5",
                    "equivalent_coins_name": "name_2"
                },
                {
                    "coin_name": "name_5",
                    "equivalent_coins_name": "name_3"
                },
                {
                    "coin_name": "name_5",
                    "equivalent_coins_name": "name_4"
                },
            ]
        }
    ...
    def test_json_coin_type_manager_build_from_json_invalid_un_known_equivalent_coin_name(self):
        # Arrange
        self._mock_json['coin_equivalents'].append(
            {
                "coin_name": "name_unknown",
                "equivalent_coins_name": "name_4"
            }
        )
        # Act
    ...
    def test_json_coin_type_manager_build_from_json_invalid_un_known_equivalent_equivalent_coins_name(self):
        # Arrange
        self._mock_json['coin_equivalents'].append(
            {
                "coin_name": "name_0",
                "equivalent_coins_name": "name_unknown"
            }
        )
        # Act
        # Assert
