...
class TestJsonPlayerCoinInventory(unittest.TestCase):
    ...
    def set_up_player_coin_inventory(self):
        ...
        self._mock_player_coin_inventory_init = (
            self._player_coin_inventory_patcher.start()
        )
    ...
    def setUp(self):
        ...
        self._mock_json = {"coin_stocks": self._mock_coin_stocks}
        ...
        self._mock_coin_type_manager.get_coin_by_name.side_effect = lambda name: self._coin_name_map[
            name
        ]
    ...
    def test_json_player_coin_inventory_init(self):
        ...
        object_pointer = json_player_coin_inventory.JsonPlayerCoinInventory(
            self._mock_coin_type_manager, mock_dict
        )
        # Assert
        self._mock_player_coin_inventory_init.assert_called_once_with(
            object_pointer, self._mock_coin_type_manager, mock_dict
        )
    ...
    def test_json_player_coin_inventory_build_from_json_invalid_coin_name_not_in_manager(
        self
    ):
        # Arrange
    ...
    def test_json_player_coin_inventory_get_json_schema(self):
        ...
        # Assert
        self.assertEqual(
            object_pointer.get_json_schema(), json_schemas.JSON_PLAYER_COIN_INVENTORY
        )
