...
class TestSponsorReserve(unittest.TestCase):
    ...
    def test_sponsor_reserve_init_valid(self):
        ...
        # Assert
        self.assertEqual(test_sponsor_reserve.get_remaining_sponsor_set(), self._mock_sponsor_set)
    ...
    def test_sponsor_reserve_init_invalid_sponsor_not_in_manager(self):
        ...
        with self.assertRaises(ValueError):
            _ = sponsor_reserve.SponsorReserve(self._mock_sponsor_manager, self._mock_sponsor_set)
    ...
    def test_sponsor_reserve_get_sponsor_set(self):
        ...
        test_sponsor_reserve = sponsor_reserve.SponsorReserve(self._mock_sponsor_manager, self._mock_sponsor_set)
        # Assert
        self.assertEqual(test_sponsor_reserve.get_sponsor_manager(), self._mock_sponsor_manager)
    ...
    def test_sponsor_reserve_get_remaining_sponsor_set(self):
        ...
        test_sponsor_reserve = sponsor_reserve.SponsorReserve(self._mock_sponsor_manager, self._mock_sponsor_set)
        # Assert
        self.assertEqual(set(test_sponsor_reserve.get_remaining_sponsor_set()), set(self._mock_sponsor_set))
    ...
    def test_sponsor_reserve_to_json(self):
        ...
        expected = {
            ...
            "sponsors": [
                sponsor.get_name() for sponsor in self._mock_sponsor_set
            ]
        }
